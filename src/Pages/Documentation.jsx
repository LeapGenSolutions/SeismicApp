...
import {
  ...
  Link as LinkIcon, Video, FileText, Users, Settings, BookOpen,
  CalendarClock, ShieldCheck, Plug, BrainCircuit, Smile, ActivitySquare, BarChart3, Handshake
} from "lucide-react";
...
function GettingStartedTab() {
  ...
  const steps = [
    {
      icon: <UserPlus className="w-6 h-6 text-blue-500" />, title: "Log In with Microsoft", num: 1, details: (
        <ul className="text-sm list-disc ml-6 mt-2 space-y-1">
          <li>Click "Log In" on the homepage</li>
          <li>You will be redirected to sign in with your Microsoft work account (Azure AD B2B)</li>
          <li>Only users invited to the tenant or part of the organization can log in</li>
          <li>Make sure pop-ups are enabled for Microsoft login</li>
        </ul>
      )
    },
    {
