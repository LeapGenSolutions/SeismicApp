...
const Soap = ({
  ...
  }, [encounterId, appointmentId, username, appointment?.athena_patient_id, isAthenaAppointment, data?.ehr_patient_id, data?.ehr_encounter_id]);
